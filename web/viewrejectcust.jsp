<%-- 
    Document   : viewrejectcust
    Created on : Mar 31, 2023, 2:11:44 PM
    Author     : admin
--%>
...
<head>
 ...
 <body>
 <form action="viewrejectcust.jsp" method="post">
<h1>Order Rejected Details</h1>
<hr>
<br>
 </form>
<table>
...
try
    {
        ...
        Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/hts1", "root","");
        Statement st=con.createStatement();
        ResultSet rs=st.executeQuery("select allotmentid,cid,cname,emailid,mobno,state,city,pincode,locality,flatno from allotment where aname="+an+" and allotflag=3");
        while(rs.next())
        {
            int p1=rs.getInt(1);
