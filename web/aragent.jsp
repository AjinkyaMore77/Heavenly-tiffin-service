<%-- 
    Document   : aragent
    Created on : Feb 20, 2023, 4:16:08 PM
    Author     : admin
--%>
...
try
    {
        ...
        int f=0;
        ResultSet rs=st.executeQuery("select * from agent where aflag=0");
        while(rs.next())
        {
            int p=rs.getInt(1);
            ...
            out.println("<td><a href=approvea.jsp?id="+p+">Approve</a>");
            out.println("<td><a href=rejecta.jsp?id="+p+">Reject</a>");
        }
    }
    catch(Exception e)
    {
