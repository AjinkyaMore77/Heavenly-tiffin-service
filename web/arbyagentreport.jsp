<%-- 
    Document   : arbyagentreport
    Created on : Mar 28, 2023, 10:50:45 AM
    Author     : admin
--%>
...
<head>
 ...
 <body>
 <h1>Approve Customer By Agent</h1>
<hr>
<table>
    <tr class="header">
    <th>Agent Name</th>
...
try
    {
        ...
        ResultSet rs=st.executeQuery("select allotmentid,aname,cid,cname,emailid,mobno,state,city,pincode,locality,flatno from allotment where allotflag=2 ");
        while(rs.next())
        {
            int p=rs.getInt(1);
