<%-- 
    Document   : tiffincustreport
    Created on : Apr 1, 2023, 12:31:09 PM
    Author     : admin
--%>
...
<head>
 ...
 <body>
 <form action="tiffincustreport.jsp" method="post">
<h1>Tiffin wise Customer Report</h1>
<hr>
<br>
    <div class="row">
...
<br>
    ...
    try{
       ...
       // int f=0;
        ResultSet rs=st.executeQuery("select distinct(tifftitle) from ordertiffin");
...
try
    {
        ...
        Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/hts1", "root","");
        Statement st=con.createStatement();
        ResultSet rs=st.executeQuery("select orderid,cid,custname,emailid,mobno,custstate,ctv,pincode,lsl,bfno from ordertiffin where tifftitle="+tiff+"");
        while(rs.next())
        {
            int p=rs.getInt(1);
