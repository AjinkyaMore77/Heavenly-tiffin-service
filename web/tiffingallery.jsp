<%-- 
    Document   : tiffingallery
    Created on : Feb 27, 2023, 9:46:28 PM
    Author     : admin
--%>
...
//            String path="'"+request.getContextPath()+rs.getString(6)+"'";
//            out.println("<td><img src="+path+" height=60 width=90></td>");
            out.println("<td><a href=ordertiffin.jsp?id="+p+">Order Now</a>");
        }
    }
    catch(Exception e)
    {
